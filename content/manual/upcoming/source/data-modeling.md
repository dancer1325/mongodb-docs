...
data-modeling-schema-iteration-example.

### Document Relationships

The value of a document field can include any of the BSON data types, including other documents, arrays, and arrays of documents. These
...
In MongoDB, you can model relationships by either embedding or referencing
