...
exhausts all results in the cursor. However, for capped collections you can use a tailable cursor that remains open after the client exhausts the results in the
...
To create a tailable cursor in `mongosh`, see
`cursor.tailable()`.
