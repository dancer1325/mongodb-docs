...
For more information on performance, see performance.
...
- Ensure that your query performed an index scan, rather than
  ...
  to interpret plan results, see interpret-explain-plan.
...
- **Unbound arrays:** Arrays in a document that can grow without
  ...
  information, see unbounded-arrays-anti-pattern.
...
- **Embedded documents without bounds:** MongoDB supports inserting documents
  ...
  For more information, see bloated-documents-antipattern.
