...
to get you connected and running CRUD operations as quickly as possible.

> **Note**
>
> This cheat sheet includes common MongoDB commands, but is not comprehensive.
> See \[Database Commands\](<https://www.mongodb.com/docs/manual/reference/command/>) and mongosh Methods for full lists.
...
> **Important**
>
> These are [MongoDB database tool](https://www.mongodb.com/docs/database-tools/) commands, not mongosh
