...
- - function
  ...
  - A function that takes two parameters, `key` and
    ...
    For an example, see ex-ejson-function.
...
- Mozilla Developer Network \[JSON.stringify()\](<https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/JSON/stringify>) documentation
