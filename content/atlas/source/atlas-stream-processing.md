...
*Explore how to process complex data streams using Atlas Stream Processing, including setup, security, and managing stream processors.

* Read, write, and transform streams of data with the same query syntax used in Atlas databases.

* Atlas Stream Processing
  * enables you -- , via [Atlas database' aggregation operations](../../manual/upcoming/source/aggregation.md), -- about streams of complex data, to 
    * read, 
    * write,
    * transform
  * allows you to
    - TODO: Build :ref:`aggregation pipelines <atlas-sp-aggregation>` to 
...
To get started with {+atlas-sp+}, you must first :ref:`configure a {+SPW+} <atlas-sp-manage-spi>`.
